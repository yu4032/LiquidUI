...
public final class OngoingActivityChipGlassArchitectureTest {
    @Test
    public void ongoingActivityChipUsesExactStaticBinderAndBackgroundViewAuthority() throws Exception {
        ...
        assertTrue(hook.contains("com.android.systemui.statusbar.chips.ui.binder.OngoingActivityChipViewBinding"));
        assertTrue(hook.contains("com.android.systemui.statusbar.chips.ui.model.OngoingActivityChipModel"));
